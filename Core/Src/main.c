...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, MOTOR_L_IN1_Pin|MOTOR_L_IN2_Pin|MOTOR_R_IN1_Pin|MOTOR_R_IN2_Pin
                          |MOTOR_STBY_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, CAN_CS_Pin|US_FRONT_TRIG_Pin|US_REAR_TRIG_Pin, GPIO_PIN_RESET);
