...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    PB5     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = CAN_SPI_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    HAL_GPIO_Init(CAN_SPI_SCK_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CAN_SPI_MISO_Pin|CAN_SPI_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(CAN_SPI_SCK_GPIO_Port, CAN_SPI_SCK_Pin);

    HAL_GPIO_DeInit(GPIOB, CAN_SPI_MISO_Pin|CAN_SPI_MOSI_Pin);
